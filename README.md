...
Click any sample to listen — GitHub's file viewer plays audio inline.
Each was generated by this repo on a regular CPU; no cherry-picking.

| Scenario | Input | Sample |
|----------|-------|--------|
| **Basic Nepali greeting** | `नमस्ते, मेरो नाम नोवा हो। म एउटा robot हुँ।` | [▶ 01_basic.wav](samples/01_basic.wav) |
| **Nepanglish — mixed scripts** | `यो robot को speed बढाउ। AC अन गर र light off गर।` | [▶ 02_nepanglish.wav](samples/02_nepanglish.wav) |
| **Pure English transliterated** | `Hello, how are you doing today?` | [▶ 03_pure_english.wav](samples/03_pure_english.wav) |
| **Numbers (Devanagari + Latin)** | `आज २०२४ साल हो। मसँग 1500 रुपैयाँ छ।` | [▶ 04_numbers.wav](samples/04_numbers.wav) |
| **Long real-world Nepanglish** | `नेपाली र अङ्ग्रेजी … हुन सक्छ।` (full paragraph) | [▶ 05_streaming_long.wav](samples/05_streaming_long.wav) |
| **Messy punctuation** | `She said "hello" — then left… नमस्ते।` | [▶ 06_punctuation.wav](samples/06_punctuation.wav) |

To re-render these locally (e.g. after editing prosody), run
